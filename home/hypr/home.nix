...
, ...
  ...
  wayland.windowManager.hyprland = {
    ...
    extraConfig = with pkgs;  ''
      ...
      bind = SUPER, V, exec, ${cliphist}/bin/cliphist list | rofi -dmenu | ${cliphist}/bin/cliphist decode | ${wl-clipboard}/bin/wl-copy                  bind = SUPER, escape, exec, ${wlogout}/bin/wlogout --protocol layer-shell -b 5 -T 400 -B 400
