...
*** Typescript
Attaching modes as Emacs does not seem to realize that they do exist.
#+begin_src elisp
...
#+RESULTS:
: ((alpha-background . 85) (alpha-background . 100) (font . JetBrainsMono Nerd Font-15) (vertical-scroll-bars))
